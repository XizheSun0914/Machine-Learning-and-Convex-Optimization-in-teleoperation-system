...
function setup(block)
  ...
  block.NumOutputPorts = 2;  % wrench_c
...
function Outputs(block)
  ...
  forces_e_n_1 = reshape(block.Dwork(1).Data,2,4);
  ...
  E_n = E_n_1 + delta_xy'*Bl*delta_xy + delta_theta'*Ba*delta_theta;
  
  for i=1:1:4
      Fd_i_n_1 = forces_e_n_1(:,i);
      r_i_n_1 = r_n_1(:,i);
  ...
  moment=0;
  for i=1:1:4
      force = force+forces_e_n(:,i);
      moment3 = cross([r_n(:,i);0],[forces_e_n(:,i);0]);
